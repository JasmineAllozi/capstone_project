...
class Model
{
    ...
    public function __destruct()
    {
     ...
     /**
     * get all the element from each table in database
     *
     * 
     * @return array
     */
    public function get_all(): array
    {
     ...
     /**
     * get specific element from the table by ID
     *
     * @param int $id
     * @return object
     */
    ...
    public function get_by_id($id)
    {
     ...
     /**
     * delete element from table by ID 
     *
     * @param int $id
     * @return void
     */
    public function delete($id)
    {
     ...
     /**
     * create an element in any table 
     *
     * @param array $data
     * @return void
     */
    ...
    public function create($data)
    {
     ...
     /**
     * update element in a specific table 
     *
     * @param array $data
     * @return void
     */
